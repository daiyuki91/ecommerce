...
class Category extends Model {
	...
	public static function getPage($page = 1, $itemsPerPage = Category::ITEMS_PER_PAGE)
	{
	...
	public static function getPageSearch($search, $page = 1, $itemsPerPage = Category::ITEMS_PER_PAGE)
	{
